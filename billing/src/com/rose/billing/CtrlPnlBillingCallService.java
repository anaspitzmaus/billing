...
import com.rose.db.DB;
import com.rose.db.Dlg_DBSettings;
import com.rose.db.Physician;
import com.rose.db.SQL_INSERT;
import com.rose.db.SQL_SELECT;
...
//						dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
	...
	class CreateBillListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
	        ...
	        sline.setColor(ColorConstants.BLACK);
